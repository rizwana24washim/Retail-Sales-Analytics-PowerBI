...
| File                | Description                 |
| ------------------- | --------------------------- |
| `Retail Sales.pbix` | Complete Power BI dashboard |
...
1. Download `Retail Sales.pbix` from this repository.
2. Open the file in Power BI Desktop.
3. Use the available slicers to filter the dashboard.
4. Explore the sales, profit, customer, pricing, category, and Key Influencers analyses.
...
* Presenting multiple dimensions of retail performance
* Designing an interactive reporting interface
